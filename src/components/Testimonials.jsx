      ...
      <div className="container px-5 py-24 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-white shadow shadow-orange-600/20 p-8 rounded-2xl">
              <svg
              ...
              <p className="leading-relaxed mb-6">
                We had a traditional Sushi Roll and Ramen, Grilled Meat. It was
                our first experience having this dish, and although a bit dry,
                it tasted great.
              </p>
              <a href="/" className="inline-flex items-center">
                ...
                <span className="flex-grow flex flex-col pl-4">
                  <span className="title-font font-bold text-gray-600">
                    Holden Caulfield
                  </span>
                </span>
              </a>
